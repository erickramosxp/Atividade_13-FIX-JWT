...
import com.example.api_user.model.CustomUserDetails;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        String id = jwtTokenProvider.extractIdUser(jwt);
        ...
        // Se o id de usuário for válido e não houver autenticação já ativa no contexto de segurança...
        if (id != null && SecurityContextHolder.getContext().getAuthentication() == null) {
            ...
            System.out.println("Token invalido ou exprirado");
        }
